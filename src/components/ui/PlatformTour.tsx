...
const STEPS: TourStep[] = [
  ...
  {
    icon: '📩',
    title: 'Client-ലേക്ക് അയച്ചു കൊടുക്കൂ!',
    body: 'നിങ്ങളുടെ പോർട്ടൽ ലിങ്കുകൾ റെഡിയാണ്! Organization Head ലിങ്ക് കോപ്പി ചെയ്ത് ക്ലയന്റിന് അയക്കുക. അവർക്ക് ലോഗിൻ ചെയ്ത് ഡാറ്റയും ഫോട്ടോകളും അപ്‌ലോഡ് ചെയ്യാം.',
    nextLabel: 'ടൂർ ഫിനിഷ് ചെയ്യാം 🎉',
  },
];
